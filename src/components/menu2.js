...
const Menuu = () => {
    return (                 
        <div className="bg-cover bg-center bg-gray-900 py-20">
            <div className="flex flex-col px-6 items-center">
                <h1 className="text-6xl font-bold text-white text-center text-4xl py-20 mb-8">Our Menu!! <span className='text-red-600'></span></h1>
                <div className=' '>
