...
const Menuu = () => {
   ...
   // style={{backgroundImage: `url(${backgroundImage})`}}
    ...
    return (                 
        <div className="bg-cover relative  bg-center bg-gray-900 py-20" >
           <img src={image22} alt="Background Image 22" className="absolute w-full h-80%" style={{ top: 0 }} />
           {/* <img src={image1} alt="Background Image 1" className="  opacity-20" style={{ width: '100%', height: 'auto' }} /> */}
            <div className="flex flex-col px-6 items-center">
                ...
                <div className="hidden md:block">
                    <div className='grid grid-rows text-center items-center gap-6'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-20">
                            ...
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 140</p>
                                <p className="text-lg text-white font-semibold text-center">Veg Manchurian</p>
                            </div>
                            {/* Combo 2 */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 150</p>
                            ...
                            {/* Combo 10 */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 130</p>
                            ...
                            {/* Combo 12 */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 120</p>
                            ...
                            {/* Combo 19 */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 100</p>
                ...
                <div>
                    ...
                    <img src={image13} alt="Background Image 1" className="absolute bottom-50    opacity-10" style={{maxWidth: '100%', maxHeight: '100%'}} />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-20">
                            ...
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 70</p>
                            ...
                            {/* Soup 6 */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 80</p>
            ...
            <div className="flex flex-col items-center">
                    ...
                    <div className='grid grid-rows gap-5'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                            {/* Veg Hyderabadi */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 150</p>
                            ...
                            {/* Veg Punchmela */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 160</p>
                    ...
                    <div className='grid grid-rows gap-5'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                            ...
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 180</p>
                                <p className="text-lg text-white font-semibold text-center">Paneer Butter Masala</p>
                            </div>
                            {/* Paneer Kadhai */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 170</p>
                    ...
                    <div className='grid grid-rows gap-5'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                            ...
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 60</p>
                                <p className="text-lg text-white font-semibold text-center">Green Salad</p>
                            </div>
                            {/* Cucumber Salad */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 50</p>
                                <p className="text-lg text-white font-semibold text-center">Cucumber Salad</p>
                            </div>
                            {/* Mix Raita */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 69</p>
                            ...
                            {/* Fried Papad */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 35</p>
                                <p className="text-lg text-white font-semibold text-center">Fried Papad</p>
                            </div>
                            {/* Roasted Papad */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 30</p>
                                <p className="text-lg text-white font-semibold text-center">Roasted Papad</p>
                            </div>
                            {/* Masala Papad */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 45</p>
                    ...
                    <div className='grid grid-rows gap-5'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                            ...
                            {/* Prawn Fried Rice */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 200</p>
                    ...
                    <div className='grid grid-rows gap-5'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                            ...
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 10</p>
                                <p className="text-lg text-white font-semibold text-center">Tawa Roti</p>
                            </div>
                            {/* Butter Roti */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 12</p>
                                <p className="text-lg text-white font-semibold text-center">Butter Roti</p>
                            </div>
                            {/* Plain Paratha */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 25</p>
                    ...
                    <div className='grid grid-rows gap-5'>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                            {/* Paneer Roll */}
                            <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                                <p className="text-lg text-red-500 font-semibold text-center">Rs 65</p>
               ...
               <div className='grid grid-rows gap-5'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                        ...
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 160</p>
                            <p className="text-lg text-white font-semibold text-center">Chilly chicken(Bone less)</p>
                        </div>
                        {/* Chicken Manchurian */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 150</p>
                        ...
                        {/* Prawn 65 */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 250</p>
                ...
                <div className='grid grid-rows gap-5'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                        ...
                        {/* Chicken Bharta */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 190</p>
                ...
                <div className='grid grid-rows gap-5'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                        ...
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 290</p>
                        ...
                        {/* Prawn Butter Masala */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 300</p>
                ...
                <div className='grid grid-rows gap-5'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                        ...
                        {/* Egg Bhurj Curry */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 90</p>
                ...
                <div className='grid grid-rows gap-5'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                        ...
                        {/* Tamato Rice */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 110</p>
                ...
                <div className='grid grid-rows gap-5'>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-15 gap-28">
                        ...
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 780</p>
                        ...
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 40</p>
                            <p className="text-lg text-white font-semibold text-center">Sprite/Thums up(750ml)</p>
                        </div>
                        {/* Veg biryani (3 Plates) */}
                        <div className="bg-gradient-to-b from-gray-700 to-gray-900 bg-opacity-0 border rounded-lg overflow-hidden flex flex-col items-center p-8">
                            <p className="text-lg text-red-500 font-semibold text-center">Rs 750</p>
