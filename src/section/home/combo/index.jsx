...
import backgroundImage from '../../../img/img3.png';
...
const SpecialCombosSection = () => {
    ...
    return (
        <div className="relative bg-cover bg-center pt-10 bg-gray-900" style={{ backgroundImage: `url("https://firebasestorage.googleapis.com/v0/b/brandladder-webapp.appspot.com/o/client-project%2Flove-kathi%2Fimg3.png?alt=media&token=464df09c-9dcc-4924-bfdd-f050d7596eff")`, backgroundSize: '100%', backgroundRepeat: 'no-repeat' }}> 
            {/* Blue overlay */}
            ...
            <div className="hidden md:block">
                <div className="flex flex-col items-center relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 py-15 gap-28">
                        {
